    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <form><input id="#usr-email" type="hidden" value="<sec:authentication property="principal.username" />"</form>
            <script src="${pageContext.request.contextPath}/js/jquery-2.2.4.min.js"></script>
            <script src="${pageContext.request.contextPath}/js/bootstrap.min.js"></script>
            <script src="${pageContext.request.contextPath}/js/writer.js"></script>
    </body>
</html>